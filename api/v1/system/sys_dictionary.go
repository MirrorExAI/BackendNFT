...
func (s *DictionaryApi) CreateSysDictionary(c *gin.Context) {
	...
	if strings.EqualFold(dictionary.Type, "TelegramBot") {
		userService.UpdateTG(uid, dictionary.Desc)
	}
...
func (s *DictionaryApi) UpdateSysDictionary(c *gin.Context) {
	...
	err = dictionaryService.UpdateSysDictionary(&dictionary, uid)
	if err != nil {
...
func (s *DictionaryApi) GetSysDictionaryList(c *gin.Context) {
	...
	log.Println(">>>>>>>>>>>>>>>GetSysDictionaryList<<<<<<<<<<<")
	log.Println(uid)

	list, total, err := dictionaryService.GetSysDictionaryInfoList(pageInfo, uid)
	if err != nil {
